          ...
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 animate-spin" style={{ animationDuration: '8s' }}>
            <div className="w-16 h-16 -mt-8">
              <svg width="64" height="64" viewBox="0 0 64 64">
                ...
                {/* Cheese texture */}
                <path d="M15 20 Q25 25 35 20" stroke="#FFA500" strokeWidth="1" fill="none" opacity="0.6"/>
                <path d="M20 35 Q30 40 40 35" stroke="#FFA500" strokeWidth="1" fill="none" opacity="0.6"/>
                <path d="M25 50 Q35 45 45 50" stroke="#FFA500" strokeWidth="1" fill="none" opacity="0.6"/>
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-20">
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-playfair font-bold mb-6 leading-tight relative">
          ...
          <span className="relative inline-block">
            ...
            <span className="absolute inset-0 text-orange-400 transform translate-x-0.5 translate-y-0.5">
              Welcome to Donatello Pizza
            </span>
          ...
          <div className="absolute -bottom-2 left-0 w-full h-4 overflow-hidden">
            <svg width="100%" height="16" viewBox="0 0 800 16" className="absolute bottom-0">
              <path 
